          ...
          <div className="w-full h-8 bg-white mt-1 rounded-md">
            ...
            >
              <input
                ...
                type="text"
                className="w-full h-full bg-gray-100 rounded-md p-2 text-md capitalize outline-0 my-1 focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white/75 focus-visible:ring-offset-2 sm:text-sm tracking-wide"
              />
            </Transition>
          </div>
