...
const NavBar = () => {
  ...
  return (
    <div className="w-screen h-screen md:max-w-[1534px] mx-auto px-8 underline underline-offset-2 flex flex-col justify-center md:justify-between items-center md:flex-row font-roboto text-lg font-light md:h-[55px] md:flex-wrap">
      ...
      {!showModal ? (
        <div className="py-1 px-2 rounded-md bg-[#333] flex justify-center items-center cursor-pointer">
          <PiDotsNineBold color="#fff" className="text-2xl" onClick={toggleModal} />
        </div>
      ) : (
